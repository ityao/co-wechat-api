 ...
 */
exports.sendWXATemplate = async function (openid, template_id, page, form_id, data, color, emphasis_keyword) {
  const { accessToken } = await this.ensureAccessToken();
  var apiUrl = this.prefix + 'message/wxopen/template/send?access_token=' + accessToken;
  var template = {touser: openid,template_id,page,form_id,data,color,emphasis_keyword};
